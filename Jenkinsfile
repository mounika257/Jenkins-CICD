...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://13.201.40.80:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#ci-cd-alerts', //update and provide your channel name
